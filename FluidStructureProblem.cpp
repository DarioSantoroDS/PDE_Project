...
double FluidStructureProblem::compute_velocity_error(const VectorTools::NormType &norm_type) const
{
  ...
  // std::cout << ExactSolution_onlyu::n_components() << "and" stokes_fe.n_components() << std::nedl
...
std::cout << "error_per_cell.size() = "
          << error_per_cell.size() << std::endl;

  double velocity_error = VectorTools::compute_global_error(triangulation,
                                                          error_per_cell,
                                                          VectorTools::L2_norm);
  std::cout << "Computed velocity error." << std::endl;
